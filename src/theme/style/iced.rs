...
impl iced_checkbox::Catalog for Theme {
    ...
    fn style(
        ...
        match status {
            iced_checkbox::Status::Active { is_checked } => match class {
...
pub enum Container {
    ...
    Card,
    ContextDrawer,
    Custom(Box<dyn Fn(&Theme) -> iced_container::Style>),
    Dialog,
    Dropdown,
    HeaderBar {
        focused: bool,
...
impl Container {
    pub fn custom<F: Fn(&Theme) -> iced_container::Style + 'static>(f: F) -> Self {
        Self::Custom(Box::new(f))
    }
...
impl<'a> From<iced_container::StyleFn<'a, Theme>> for Container {
        ...
        match status {
            scrollable::Status::Active => {
                ...
                if matches!(class, Scrollable::Permanent) {
                    ...
                    neutral_3.alpha = 0.7;
                    a.container.background = Some(Background::Color(neutral_3.into()));
                }
...
impl text_input::Catalog for Theme {
    ...
    fn style(&self, class: &Self::Class<'_>, status: text_input::Status) -> text_input::Style {
        ...
        match status {
            ...
            text_input::Status::Disabled => appearance,
        }
    }
}
...
impl iced_widget::text_editor::Catalog for Theme {
    ...
    fn style(
        ...
        match status {
            ...
            iced_widget::text_editor::Status::Hovered => todo!(),
